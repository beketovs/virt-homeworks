...
- В чём отличие режимов работы сервисов в Docker Swarm кластере: replication и global?\
 ...
 global - разоварачивает один сервис на каждом узле. При добавленни нового узла на нем также разворачивается сервис. Удобно настраивать использовать например для агентов мониторинга.
